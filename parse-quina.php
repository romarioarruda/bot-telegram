<?php
define('URL_QUINA',"http://g1.globo.com/loterias/quina.html");

class ParseQuina implements Bot
{
    private $url;

    public function __construct($url = URL_QUINA)
    {
        $this->url = $url;
    }
    ...
    public function crawler() {
        ...
        if (!empty($html)) {
            ...
            preg_match_all('#content-lottery__result--quina">(.*?)</div>#is', $html, $concurso_numeros);
