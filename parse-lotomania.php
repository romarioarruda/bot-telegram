<?php
define('URL_MANIA',"http://g1.globo.com/loterias/lotomania.html");

class ParseLotoMania implements Bot
{
    private $url;

    public function __construct($url = URL_MANIA)
    {
        $this->url = $url;
    }
    ...
    public function crawler() {
        ...
        if (!empty($html)) {
            ...
            preg_match_all('#content-lottery__result--lotomania">(.*?)</div>#is', $html, $concurso_numeros);
